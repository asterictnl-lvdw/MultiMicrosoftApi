...
$MethodsRequired = Invoke-MSALAPI -Url "https://management.azure.com/subscriptions/b1e7d08a-3165-4386-b924-7926fe4af0f0/providers/Microsoft.Security/autoProvisioningSettings?api-version=2017-08-01-preview" -Resource "https://management.core.windows.net" -ClientId "1950a258-227b-4e31-a9cf-717495945fc2" -Method 'GET'
